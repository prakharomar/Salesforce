...
import NUMBER_FIELD from '@salesforce/schema/Account.NumberofLocations__c';
import accountRecMethod from '@salesforce/apex/createPassenger.accountRecMethod';
...
export default class AccountRecCreation extends LightningElement {
    ...
    recAccount = {
        ...
        NumberofLocations__c: this.number
    }
    ...
    handleNUMberchange(event){
        this.recAccount.NumberofLocations__c = event.target.value;
        //console.log("industry",this.recAccount.Industry);
    }
        ...
        accountRecMethod({ accRec : this.recAccount })
            .then(result => {
                ...
                if(this.message !== undefined) {
                    ...
                    this.recAccount.NumberofLocations__c ='';
                    this.dispatchEvent(
                        new ShowToastEvent({
                            title: 'Success',
